    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-grid">
          ...
          <div>
            ...
            <p className="footer-description">
              ...
              occasion and palate, bringing you premium quality and unforgettable experiences.
            </p>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">© {currentYear} Wine Cellar. All rights reserved.</p>
          <div className="footer-payment">
            <span className="footer-payment-text">We accept:</span>
            <div className="footer-payment-icons">
              <div className="payment-icon payment-visa">V</div>
              <div className="payment-icon payment-mastercard">M</div>
              <div className="payment-icon payment-amex">A</div>
            </div>
          </div>
        </div>
      </div>
